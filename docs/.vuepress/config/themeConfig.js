...
module.exports = {
  ...
  author: {
    ...
    name: 'Jamey', // 必需
    // link: 'https://github.com/oliver556', // 可选的
  },

  blogger: {
    // 博主信息，显示在首页主体右侧
    // avatar: 'https://cdn.staticaly.com/gh/oliver556/image-hosting@master/20220108/avatar_01.3arwwk336g00.jpg',
  ...
  indexImg: {
    ...
    // desc: ["一个95后程序员，终身学习者。 —— 来自 Jamey Lee", "故事由我书写，旅程由你见证，传奇由她聆听 —— 来自 Jamey Lee", "这一生波澜壮阔或是不惊都没问题 —— 来自 Weibw"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFadeIn 为 true 生效
    desc: ["May you be like that lime,the more others pour you cold water,the more you boil. —— 来自 Jamey Lee", "这一生波澜壮阔或是不惊都没问题 —— 来自 Weibw"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFadeIn 为 true 生效
