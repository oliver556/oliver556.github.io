...
那么又该如何判断类数组对象和数组呢？实际上，我们在 [《JavaScript专题之类型判断(下)》](05.JavaScript专题之类型判断%28下%29.md) 就讲过jQuery 数组和类数组对象判断函数 isArrayLike 的实现。
...
![javascript_03-18_01](https://cdn.jsdelivr.net/gh/oliver556/image-hosting@master/20220318/javascript_03-18_01.3t81xp1xgws0.webp)
...
![javascript_03-18_02](https://cdn.jsdelivr.net/gh/oliver556/image-hosting@master/20220318/javascript_03-18_02.by7e9tfi2t4.webp)
