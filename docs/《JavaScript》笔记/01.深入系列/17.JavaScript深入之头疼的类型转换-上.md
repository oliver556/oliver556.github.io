...
![javascript_03-13_02](https://fastly.jsdelivr.net/gh/oliver556/image-hosting@master/20220313/javascript_03-13_02.51uap0a72bc0.jpg)
...
![javascript_03-13_03](https://fastly.jsdelivr.net/gh/oliver556/image-hosting@master/20220313/javascript_03-13_03.1knehv57h2m8.jpg)
...
而另一个转换对象的函数是 valueOf，表示对象的原始值。默认的 valueOf 方法返回这个对象本身，数组、函数、正则简单的继承了这个默认方法，也会返回对象本身。
